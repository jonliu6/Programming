...
@Path("/demo")
/**
 * assuming the URL context is http://localhost:8080/RESTEasyDemo
 * @author 
 *
 */
public class DemoService {
    ...
    @Path("/hello/{msg}")
    /**
     * URL: http://localhost:8080/RESTEasyDemo/rest/demo/hello/msg
     * Method: GET
     * @param msg
     * @return
     */
    ...
    /**
     * URL: http://localhost:8080/RESTEasyDemo/rest/demo/allbooks
     * Method: GET
     * @return
     */
    ...
    @Produces("application/json")
    /**
     * URL: http://localhost:8080/RESTEasyDemo/rest/demo/book/isbn
     * Method: GET
     * @param isbn
     * @return
     */
    ...
    @Produces("application/json")
    /**
     * URL: http://localhost:8080/RESTEasyDemo/rest/demo/book/add
     * Method: POST
    ...
    @Produces("application/json")
    /**
     * URL: http://localhost:8080/RESTEasyDemo/rest/demo/book/update/isbn
     * Method: PUT
     * Data: JSON string of a book
     * Note: when posting, change the header to "Content-Type: application/json"
     * @param isbn
    ...
    @Produces("application/json")
    /**
     * URL: http://localhost:8080/RESTEasyDemo/rest/demo/book/delete/isbn
     * Method: DELETE
     * @param isbn
     * @return
     */
