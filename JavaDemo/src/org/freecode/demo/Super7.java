...
public class Super7
{
  ...
  private final static int CEILING_NUMBER = 45;
  private final static int NUMBER_PER_DRAW = 7;
  ...
  public void init()
  {
    ...
    int i = 0;
    while (luckyNumberSet_.size() < NUMBER_PER_DRAW)
    {
      ranNum = new RandomNumber(CEILING_NUMBER);
